...
namespace AssemblyCSharp
{
    public class APIS
    {
        ...
        public const string UPDATE_INFO_JSON_URL = "http://192.168.10.100/download/update.xml";//服务器上最新的软件版本信息存储文件
  //      public static string chatSocketUrl = "61.160.223.36";
        ...
        public const string PIC_PATH = "http://119.23.128.56:8080/download/";
        //	public const string apkDownLoadurl="192.168.10.100/aaa/weipai.apk";
        public const string ImgUrl = "http://119.23.128.56:9096/weiPaiImage/";
